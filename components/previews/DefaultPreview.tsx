      ...
      <PreviewContainer>
        <div className="md:flex px-5 py-4 md:space-x-8 items-center">
          ...
          <div className="md:flex-1 flex flex-col py-4 space-y-2">
            <div>
              <div className="font-medium text-xs opacity-80 uppercase py-2">수정한 날짜</div>
              <div>{formatModifiedDateTime(file.lastModifiedDateTime)}</div>
            </div>

            <div>
              <div className="font-medium text-xs opacity-80 uppercase py-2">파일 크기</div>
              <div>{humanFileSize(file.size)}</div>
            </div>

            <div>
              <div className="font-medium text-xs opacity-80 uppercase py-2">MIME 타입</div>
              <div>{file.file.mimeType}</div>
            </div>

            <div>
              <div className="font-medium text-xs opacity-80 uppercase py-2">해시</div>
